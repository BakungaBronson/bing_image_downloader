...
force_replace=False, timeout=60, filter="",resize=None, verbose=True, license='Public Domain'):
    ...
    bing = Bing(query, limit, image_dir, adult, timeout, filter,resize, verbose, license=license)
    bing.run()
